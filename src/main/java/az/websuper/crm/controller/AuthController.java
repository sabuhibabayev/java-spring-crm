...
public class AuthController {
    ...
    public ResponseEntity registerEmployee(@RequestBody RegisterEmployeeDto registerEmployeeDto,Principal principal){
     String adminEmail = principal.getName();
        userService.registerEmployee(adminEmail,registerEmployeeDto);
        return ResponseEntity.ok(HttpStatus.CREATED);
    }
